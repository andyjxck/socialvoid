...
export const Card = ({
    ...
    <View style={{ flex: 1, position: "relative" }}>
      ...
      >
        <LinearGradient
          ...
          style={{ flex: 1, borderRadius: 16, padding: 1 }}
        >
          <View
            style={{
              flex: 1,
  ...
  const cardBack = (
    <View style={{ flex: 1, position: "relative" }}>
      <BlurView intensity={60} tint="dark" style={{ flex: 1, borderRadius: 16 }}>
        <LinearGradient
          colors={[
            "rgba(30, 30, 30, 0.98)",
            "rgba(45, 25, 55, 0.95)",
        ...
        >
          ...
          >
            {/* pattern */}
            <View style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, borderRadius: 15 }}>
  ...
  return (
    ...
    >
      {card.faceUp ? cardFront : cardBack}
    </TouchableOpacity>
  );
};
