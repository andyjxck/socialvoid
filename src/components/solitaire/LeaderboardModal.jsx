...
import { X, Trophy, Medal, Award, Calendar } from "lucide-react-native";
import { useTheme } from "../../utils/theme";

export const LeaderboardModal = ({ visible, onClose }) => {
  ...
  const fetchLeaderboard = async () => {
    ...
    try {
      const response = await fetch(
        `/api/leaderboards/solitaire?period=${period}&limit=10`,
      );
